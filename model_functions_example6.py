...
import numpy as np
from simulationDriver import canteraSimulate
from simulationDriver import canteraKineticsParametersParser
import copy
...
ceO2_input_simulation_settings.surface_coverages = 'CeCation(S):0 Acetaldehyde1-Ce(S):1.00 Acetaldehyde2-Ce(S):0.0 OAnion(S):0.0'
...
def integrated_cantera_simulation_wrapper_example6(discreteParameterVector): 
    simulationOutput = cantera_simulation_wrapper_example6(discreteParameterVector)
...
totalAbsoluteRate = cantera_simulation_wrapper_example6([61.5, 41.5, 13.0, 13.0, 0.1, 0.1, #Regular kinetic params
