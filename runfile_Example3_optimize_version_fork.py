...
if __name__ == "__main__":
    ...
    UserInput.responses['responses_observed'] = responses_observed*2
    UserInput.responses['responses_observed_uncertainties'] = observedResponses_uncertainties*0.25
    ...
    UserInput.model['InputParameterPriorValues'] = [41.5, 4001.5, 13.0, 0.0, 0.1, 0.0] # Ea1_mean, Ea2_mean, log_A1_mean, log_A2_mean, gamma_1_mean, gamma_2_mean 
    ...
    UserInput.model['InputParameterInitialGuess'] = [20, 20, 13, 13.0, 0.1, 0.2]#[39.08033543, 25.85946199, 10.02022149, 14.67430303, -0.41925677,  0.62673177] #This is where the mcmc chain will start.
    ...
    UserInput.model['reducedParameterSpace']=[0,2,4]
