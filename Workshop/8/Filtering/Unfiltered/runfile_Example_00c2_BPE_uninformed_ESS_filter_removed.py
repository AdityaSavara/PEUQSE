...
if __name__ == "__main__":
    ...
    UserInput.parameter_estimation_settings['mcmc_length'] = 10000 #The uninformed prior int his example has a "bad" MCMC walker so requires lots of sampling to converge.
    ...
    UserInput.parameter_estimation_settings['mcmc_threshold_filter_coefficient'] = 'auto' #This will be ignored since filter samples is set to False.
