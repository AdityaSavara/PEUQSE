...
if __name__ == "__main__":
    ...
    UserInput.responses['responses_observed'] = theta_A_obs_synth = fun.Langmuir_replacement_three_temperatures_log([  ( -0.687 - (-0.858))*0.10,  (-1.50e-3 - (-1.45E-3)) *0.10  ]) 
    UserInput.responses['responses_observed_uncertainties'] = [np.log10(2),np.log10(2),np.log10(2)]
...
#    UserInput.model['InputParameterInitialGuess'] = [-0.687, 1.50e-3, -0.858, 1.50e-3] #This is where the mcmc chain will start.
    ...
    UserInput.model['simulationOutputProcessingFunction'] = None #np.log10 #Optional: a function to process what comes out of the simulation Function and then return an observable vector.
