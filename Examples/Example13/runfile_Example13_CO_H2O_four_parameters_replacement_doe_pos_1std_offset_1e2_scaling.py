...
#    fig.savefig('synthetic_observables_theta_A.png',dpi=220)
    ...
    prior = np.random.normal(delta_H_rxn, delta_H_rxn_uncertainty,200000) #Because we are looking at prior of deltaHrxn which is not temperature dependent, we can do it out here with a high sampling.
