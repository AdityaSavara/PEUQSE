...
if __name__ == "__main__":
    ...
    from model_functions_example4 import cantera_simulation_wrapper_example4
    # print("line 22 of runfile!!!!!!"); import sys; sys.exit()
    UserInput.model['simulateByInputParametersOnlyFunction'] = cantera_simulation_wrapper_example4 #This must simulate with *only* the parameters listed above, and no other arguments.
    ...
    UserInput.parameter_estimation_settings['mcmc_burn_in'] = 100#0 
    UserInput.parameter_estimation_settings['mcmc_length'] = 500#00
    ...
    # print("line 33 of runfile!!!!!!"); import sys; sys.exit()
    #After making the UserInput, now we make a 'parameter_estimation' object from it.
    PE_object = PEUQSE.parameter_estimation(UserInput)
    #print("line 36 of runfile!!!!!!"); import sys; sys.exit()
    ...
    #print("line 40 of runfile!!!!!!"); import sys; sys.exit()
