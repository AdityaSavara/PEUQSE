...
if __name__ == "__main__":
    ...
    import processing_function_mem_reactor as fun
    ...
    UserInput.model['InputParameterPriorValues'] = [1e2, 1, 10] # eV
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array([[10, 0, 0],[0, 10, 0],[0, 0, 10]]) #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D  This is a standard deviation!
    UserInput.model['InputParameterInitialGuess'] = [1e2, 1, 10] #This is where the mcmc chain will start.
