...
if __name__ == "__main__":    
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = [20, 20, 13, 13, 0.1, 0.1] #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D variance is acceptable.
