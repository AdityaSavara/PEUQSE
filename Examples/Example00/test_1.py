...
"""
expectedFirstPart =  -42.6 #MAP logP value.
expectedSecondPart = [165.1707312 , 500.06152225] #map parameter set
...
"""
import runfile_grid_test
outputFirstPart = runfile_grid_test.PE_object.map_logP
outputSecondPart = runfile_grid_test.PE_object.map_parameter_set
