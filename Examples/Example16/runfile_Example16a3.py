...
if __name__ == "__main__":
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = [ 0.02, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1] #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
...
#    PE_object.doMetropolisHastings()
    ...
    PE_object.doGridSearch('getLogP', gridSamplingAbsoluteIntervalSize=[0.03, 0.0025, 0.50/3, 10, 10, 1,1, 0.1, 0.1], gridSamplingNumOfIntervals=[0,0,3,3,3,3,3,2,2])
