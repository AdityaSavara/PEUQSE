...
if __name__ == "__main__":
    ...
    UserInput.model['InputParameterInitialGuess'] =[ 1.,   0. ,  0.5 ,41.5, 41.5, 13.,  13.  , 0.1 , 0.1] 
    ...
    UserInput.parameter_estimation_settings['mcmc_burn_in'] = 0 #Normally use 100 for example 3a
...
#    PE_object.doGridSearch('doMetropolisHastings', gridSamplingAbsoluteIntervalSize=[ 0.10, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1], gridSamplingNumOfIntervals=[0,0,1,0,0,0,0,0,0], passThroughArgs={"method":"Nelder-Mead", "maxiter":5000, "verbose":False})#, "maxiter":1000, "verbose":False})
