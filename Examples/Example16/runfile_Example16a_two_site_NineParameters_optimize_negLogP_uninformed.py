...
if __name__ == "__main__":
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array( [ 0.10, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1])*10 #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
