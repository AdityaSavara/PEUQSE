...
if __name__ == "__main__":
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = [ 0.05, 0.0025, 0.50/3, 20, 20, 2, 2, 0.1, 0.1] #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
    UserInput.model['InputParameterInitialGuess'] = [1.0, 0.0, 0.50,  40, 40, 13, 13.0, 0.1, 0.1] #This is where the mcmc chain will start.
    ...
    UserInput.parameter_estimation_settings['mcmc_burn_in'] = 100 #Normally use 100 for example 3a
    UserInput.parameter_estimation_settings['mcmc_length'] = 1000 #Normally use 10000 for example 3a.
    ...
    PE_object.doGridSearch('getLogP', gridSamplingAbsoluteIntervalSize=[0.03, 0.0025, 0.50/3, 10, 10, 1,1, 0.1, 0.1], gridSamplingNumOfIntervals=[0,0,0,4,4,4,4,0,0], verbose = True)
