...
if __name__ == "__main__":
    ...
    UserInput.simulated_response_plot_settings['figure_name'] = 'Posterior_Example16d' #This creates the filename, also.
...
#    PE_object.doMetropolisHastings()
    ...
    PE_object.doGridSearch('getLogP', gridSamplingAbsoluteIntervalSize=[0.03, 0.0025, 0.50/3, 10, 10, 1,1, 0.1, 0.1], gridSamplingNumOfIntervals=[0,0,3,3,3,3,3,2,2], verbose = True)
