...
#    PE_object.doMetropolisHastings()
    ...
    PE_object.doGridSearch('doOptimizeNegLogP', gridSamplingAbsoluteIntervalSize=[ 0.10, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1], gridSamplingNumOfIntervals=[0,0,1,1,1,1,1,0,0], passThroughArgs={"method":"Nelder-Mead", "verbose":False})#, "maxiter":1000, "verbose":False})
