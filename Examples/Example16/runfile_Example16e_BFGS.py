...
if __name__ == "__main__":
    ...
    UserInput.simulated_response_plot_settings['figure_name'] = 'Posterior_Example16e' #This creates the filename, also.
    ...
    UserInput.model['InputParameterInitialGuess'] = [1.0, 0.0, 0.66,  21.5, 21.5, 11, 12.0, 0.2, 0.1] #This is where the mcmc chain will start.
