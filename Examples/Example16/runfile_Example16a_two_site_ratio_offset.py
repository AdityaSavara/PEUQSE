...
if __name__ == "__main__":
    ...
    observed_data_Filename = 'ExperimentalDataAcetaldehydeTPDCeO2111MullinsTruncatedConstantErrors005Subtracted.csv'
    ...
    UserInput.model['InputParameterInitialGuess'] = [0.50, 40, 40, 13, 13.0, 0.1, 0.2] #This is where the mcmc chain will start.
