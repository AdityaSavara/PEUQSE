...
UserInput.parameter_estimation_settings['mcmc_burn_in'] = 1#100 
UserInput.parameter_estimation_settings['mcmc_length'] = 4#200
...
UserInput.parameter_estimation_settings['convergence_diagnostics'] = False #the convergence_diagnostics slows down this unit test by a factor greater than 2, so it is being turned off.
...
if len(PE_object.info_gains_matrices_array) > 0:
    PEUQSE.pickleAnObject(PE_object.info_gains_matrices_array, "runfile_for_unit_test_parallel_doe_conditions_exploration")
