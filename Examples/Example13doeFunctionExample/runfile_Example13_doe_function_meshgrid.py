...
#    print(yValues)
#    print(zValues)    
#    im = ax1.plot_trisurf(xValues,yValues, zValues)
#
#
#    fig2, ax2 =  plt.subplots(1)
#    ax2 = plt.axes(projection ='3d')
#    xValues = PE_object.info_gains_matrices_array[1][:,0]
#    yValues = PE_object.info_gains_matrices_array[1][:,1]
#    zValues = PE_object.info_gains_matrices_array[1][:,2]
#    print(xValues)
#    print(yValues)
#    print(zValues)    
#    im = ax2.plot_trisurf(xValues,yValues, zValues)
#    
#    fig3, ax3 =  plt.subplots(1)
#    ax3 = plt.axes(projection ='3d')
#    xValues = PE_object.info_gains_matrices_array[2][:,0]
#    yValues = PE_object.info_gains_matrices_array[2][:,1]
#    zValues = PE_object.info_gains_matrices_array[2][:,2]
#    print(xValues)
#    print(yValues)
#    print(zValues)    
#    im = ax3.plot_trisurf(xValues,yValues, zValues)
