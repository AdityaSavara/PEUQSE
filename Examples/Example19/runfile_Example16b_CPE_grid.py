...
if __name__ == "__main__":
    ...
    UserInput.model['InputParameterInitialGuess'] = (1.1, 0.0, 0.16666666666666669, 21.5, 21.5, 11.0, 13.0, 0.2, 0.1)  #This is where the mcmc chain will start.
...
#    PE_object.doMetropolisHastings()
    ...
    #PE_object.doGridSearch('getLogP', gridSamplingAbsoluteIntervalSize=[ 0.10, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1], gridSamplingNumOfIntervals=[1,1,3,3,3,3,3,1,1], passThroughArgs={"method":"Nelder-Mead", "maxiter":5000, "verbose":False})#, "maxiter":1000, "verbose":False})
