...
#    PE_object.doMetropolisHastings()
    ...
    PE_object.doGridSearch('getLogP', gridSamplingAbsoluteIntervalSize=[ 0.10, 0.005, 0.50/3, 20, 20, 2, 2, 0.1, 0.1], gridSamplingNumOfIntervals=[1,1,3,3,3,3,3,1,1], passThroughArgs={"method":"Nelder-Mead", "maxiter":5000, "verbose":False}, exportLog=False)# "maxiter":1000, "verbose":False})
