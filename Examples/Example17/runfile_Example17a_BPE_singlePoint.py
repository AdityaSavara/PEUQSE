...
if __name__ == "__main__":
    ...
    UserInput.parameter_estimation_settings['mcmc_length'] = 2 #Normally use 10000 for example 3a.
    ...
    PE_object.doSinglePoint(UserInput.model['InputParameterInitialGuess'])
