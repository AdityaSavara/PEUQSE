...
if __name__ == "__main__":    
    ...
    UserInput.responses['responses_abscissa'] = np.array([[3]]) # 
    UserInput.responses['responses_observed'] = np.array([[110]]) #
    ...
    UserInput.model['InputParameterPriorValues'] = [13, (81.2347*1000)] 
