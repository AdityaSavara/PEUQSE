...
if __name__ == "__main__":    
    ...
    UserInput.responses['responses_abscissa'] = np.array([[5]]) # 
    UserInput.responses['responses_observed'] = np.array([[320]]) #
    UserInput.responses['responses_observed_uncertainties'] = np.array([[30]])
    ...
    UserInput.model['InputParameterPriorValues'] = [13, (80*1000)] 
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array([2, (20*1000)]) #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
#    UserInput.model['InputParameterInitialGuess'] = [50, 40000] #This is where the mcmc chain will start.
...
#    PE_object.createSimulatedResponsesPlot()
    ...
    UserInput.contour_settings_custom['figure_name']='PosteriorContourPlotState3'
