...
if __name__ == "__main__":    
    ...
    UserInput.model['InputParameterPriorValues'] = [13, (67.63*1000)] 
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array([2, 5.30*1000]) #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
