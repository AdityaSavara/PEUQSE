...
if __name__ == "__main__":    
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array([2, 23.18614*1000]) #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
...
#    PE_object.createSimulatedResponsesPlots()
    ...
    UserInput.contour_plot_settings['max_y_ticks']=3
    ...
    UserInput.contour_plot_settings['axis_limits'] = [7,20,0,120000]
