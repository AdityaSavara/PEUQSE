...
if __name__ == "__main__":    
    ...
    UserInput.model['InputParametersPriorValuesUncertainties'] = np.array([[1,0.2], [0.3,1]]) #If user wants to use a prior with covariance, then this must be a 2D array/ list. To assume no covariance, a 1D
