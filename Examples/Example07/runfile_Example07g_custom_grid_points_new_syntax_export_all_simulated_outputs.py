...
if __name__ == "__main__":    
    ...
    #In this example, the mcmc arguments will be ignored since an mcmc is not being performed.
    ...
    PE_object.doMultiStart(searchType = 'getLogP', initialPointsDistributionType='grid', gridsearchSamplingInterval=[2,1], gridsearchSamplingRadii=[5,2])
