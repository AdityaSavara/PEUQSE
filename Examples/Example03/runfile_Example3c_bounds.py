...
if __name__ == "__main__":
    ...
    UserInput.model['InputParameterPriorValues_upperBounds'] = [100,100,20,20,100,100]
...
#    PE_object.makeSamplingScatterMatrixPlot()
    ...
    print("InputParameterPriorValues_upperBounds", UserInput.InputParameterPriorValues_upperBounds)