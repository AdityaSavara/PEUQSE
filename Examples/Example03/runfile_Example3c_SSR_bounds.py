...
if __name__ == "__main__":
    ...
    UserInput.model['InputParameterPriorValues_upperBounds'] = [100,100,15,15,100,100]
...
#    PE_object.doMetropolisHastings()
    PE_object.doOptimizeSSR(method="BFGS", printOptimum=True, verbose=True)
    print(PE_object.opt_parameter_set, PE_object.opt_SSR)
