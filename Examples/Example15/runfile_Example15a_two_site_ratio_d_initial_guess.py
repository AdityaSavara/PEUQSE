...
if __name__ == "__main__":
    ...
    UserInput.model['InputParameterInitialGuess'] = [0.86, 35, 20, 15, 11.0, 0.2, 0.1] #This is where the mcmc chain will start.
    ...
    UserInput.parameter_estimation_settings['mcmc_burn_in'] = 20000 #Normally use 100 for example 3a
    UserInput.parameter_estimation_settings['mcmc_length'] = 200000 #Normally use 10000 for example 3a.
