...
if __name__ == "__main__":
    ...
    UserInput.responses['responses_observed_uncertainties'] = observedResponses_uncertainties*0.0
    ...
    UserInput.model['responses_simulation_uncertainties'] = observedResponses_uncertainties*1.0
