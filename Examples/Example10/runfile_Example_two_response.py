...
if __name__ == "__main__":    
    ...
    UserInput.contour_settings_custom['axis_limits'] = [-2.0, 4.0, 1.0, 7.0]# for the alternate plot: [-1.0, 3.0, 3.0, 7.0]

    prep_cov_mat = np.zeros((2,2))
    np.fill_diagonal(prep_cov_mat,UserInput.model['InputParametersInitialValuesUncertainties'])
